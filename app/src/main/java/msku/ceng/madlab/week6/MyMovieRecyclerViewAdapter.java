        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mListener != null){
                    ...
                    notifyItemChanged(holder.selectIndex);
                    holder.selectIndex = holder.getLayoutPosition();
                    notifyItemChanged(holder.selectIndex);
                }

            }
        });
        holder.itemView.setBackgroundColor(holder.selectIndex == position ? Color.GREEN: Color.TRANSPARENT);
    }
